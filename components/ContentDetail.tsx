...
import type { CardContent, Content } from "@/data/contents";

// Shared presentational layout for the /movie/[id] and /series/[id] detail routes.
    ...
    <main className="min-h-screen bg-neutral-950 text-white">
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute bottom-0 left-0 p-6 md:p-12">
          ...
          <DetailActions id={content.id} title={content.title} trailerUrl={content.trailerUrl} />
        </div>
      </div>
